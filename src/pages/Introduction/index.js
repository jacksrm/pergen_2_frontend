    ...
    <>
      <div className="content">
        ...
        <p>
          ...
          >
            <FaLinkedin size={24} color={'#ff0634 '} />
          </a>{' '}
          <a
            ...
            rel="noopener noreferrer"
          >
            <FaGithub size={24} color={'#ff0634 '} />
          </a>
        </p>
        <p>
          Matheus Teixeira Rodrigues 2012913/1 - Designer e Dev. Assist{' '}
          <a
            href="https://www.instagram.com/mayh6m"
            target="_blank"
            rel="noopener noreferrer"
          >
            <FaInstagram size={24} color={'#ff0634 '} />
          </a>
        </p>
        ...
        <h3>Objetivo: </h3>
        <p>
          Construir um algoritmo que gere todas as permutações dos inteiros de 1
          até n em ordem lexicográfica.
        </p>

        <div className="bottom">
          <Link className="button" to="/permutation">
            Seguinte →
          </Link>
